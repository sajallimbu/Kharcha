...
public class AddExpenseDialog extends AppCompatDialogFragment {
    ...
    private DashboardDialogListener dashboardDialogListener;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(view).setTitle("New Expense").setNegativeButton("cancel", new DialogInterface.OnClickListener() {
            @Override
    ...
    public interface DashboardDialogListener {
        void applyTexts(String title, String description, String amount);
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            dashboardDialogListener = (DashboardDialogListener) context;
